...
All non-method functions are prefixed with the type they return (e.g., *V3New*).  Methods don't have prefixes.  Functions have a type suffix if there is more than one function that performs the same operation:

<pre>
p1 := P3FromV3(a)
p2 := P3FromV4(b)
M1 := M4Translate(1, 0, 0)
