...
vmath is a simple linear algebra library for golang and designed solely for 3D graphics.  It defines structs for points, vectors, and small matrices.
...
| V3 | 3x1 | Vector in R^3^ |
| V4 | 4x1 | Homogeneous vector |
| P3 | 3x1 | Point in R^3^, similar to a @V4@ with w=1 |
